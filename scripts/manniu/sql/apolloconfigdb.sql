...
VALUES
    ('eureka.service.url', 'default', 'http://apollo-configservice.apollo.svc.cluster.local:8080/eureka/', 'Eureka服务Url，多个service以英文逗号分隔'),
...
VALUES
	('SampleApp', 'Sample App', 'bullyun', '研发部', 'apollo', 'apollo@acme.com');
